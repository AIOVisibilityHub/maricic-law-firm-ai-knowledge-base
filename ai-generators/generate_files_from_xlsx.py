im
    ...
    # Optional: wipe generated schema folders so reruns never create -1 duplicates
    if clean:
...
if __name__ == "__main__":
    ...
    parser.add_argument('--clean', action='store_true', help='Delete generated schemas/* folders before writing (prevents -1 duplicates)')
